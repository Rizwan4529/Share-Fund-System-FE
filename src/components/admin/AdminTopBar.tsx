...
export function AdminTopBar() {
  ...
  return (
    <>
      <header className="sticky top-0 z-30 flex shrink-0 items-center gap-2 border-b border-line bg-white/86 px-4 py-3 backdrop-blur-[10px] lg:h-16 lg:gap-4 lg:px-[26px] lg:py-0">
        <Button
          type="button"
        ...
        <Button
          ...
          variant="ghost-outline"
          size="icon"
          className="size-10 shrink-0 rounded-md border-[#e0e7f1] lg:hidden"
          onClick={() => {
            closeDropdowns();
            setSearchOpen(true);
          }}
        ...
        <div className="relative hidden min-w-0 flex-1 lg:block lg:max-w-[440px]">
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-4">
          <div className="hidden overflow-x-auto sm:block">
            <AdminSegmentedControl
              ...
              size="sm"
              className="border-line bg-[#f1f4fa]"
            />
          </div>
          ...
          <div className="relative">
            ...
            {userOpen ? (
              <div className="absolute top-12 right-0 z-40 w-[min(100vw-2rem,246px)] animate-fade-up overflow-hidden rounded-[9px] border border-line bg-white shadow-[0_24px_60px_-24px_rgba(12,31,68,0.4)]">
