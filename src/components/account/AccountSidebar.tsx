...
export function AccountSidebar({
  ...
  return (
    <AppSurfaceCard padding="md" className="sticky top-24 lg:w-60">
        ...
        {ACCOUNT_SECTIONS.map((s) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-[14.5px] font-semibold transition-all",
                active
